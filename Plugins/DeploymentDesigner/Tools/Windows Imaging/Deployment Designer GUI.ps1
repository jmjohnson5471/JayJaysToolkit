...
Add-Label $form "Export Folder" 470 196 120
$txtExportFolder = New-Object System.Windows.Forms.TextBox
$txtExportFolder.Location = New-Object System.Drawing.Point(560,193)
$txtExportFolder.Size = New-Object System.Drawing.Size(520,26)
$txtExportFolder.BackColor = [System.Drawing.Color]::FromArgb(35,35,35)
$txtExportFolder.ForeColor = [System.Drawing.Color]::White
$desktop = [Environment]::GetFolderPath("Desktop")
if (!(Test-Path $desktop)) { $desktop = $env:TEMP }
$txtExportFolder.Text = Join-Path $desktop "JayJaysDeployment"
$form.Controls.Add($txtExportFolder)

$btnBrowseFolder = New-Object System.Windows.Forms.Button
$btnBrowseFolder.Text = "Browse"
$btnBrowseFolder.Location = New-Object System.Drawing.Point(1090,192)
$btnBrowseFolder.Size = New-Object System.Drawing.Size(110,28)
$form.Controls.Add($btnBrowseFolder)


$tabs = New-Object System.Windows.Forms.TabControl
$tabs.Location = New-Object System.Drawing.Point(470,230)
$tabs.Size = New-Object System.Drawing.Size(738,460)
...
$btnBrowseFolder.Add_Click({
    ...
    $dialog.Description = "Choose where to export autounattend.xml"
    $dialog.ShowNewFolderButton = $true
    if (Test-Path $txtExportFolder.Text) {
        $dialog.SelectedPath = $txtExportFolder.Text
    }
    elseif ($txtExportFolder.Text) {
        $parent = Split-Path $txtExportFolder.Text -Parent
        if ($parent -and (Test-Path $parent)) { $dialog.SelectedPath = $parent }
    }
...
foreach ($ctrl in @($cmbEdition,$cmbArch,$txtLocale,$txtKeyboard,$txtTimeZone,$txtComputerName,$txtProductKey,$chkHideEula,$chkHideOnline,$chkBypassNetwork,$chkSkipMachine,$chkSkipUser,$chkCreateUser,$txtUsername,$txtPassword,$chkAutoLogon,$chkDisableConsumer,$chkEnableRdp,$chkToolkit,$chkCtt,$txtCustom,$txtExportFolder)) {
